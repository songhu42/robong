...
def main(args=None):
    ...
    msg_node = sub.Msg_sub("message")
    time_node = sub.Time_sub("time")
    ...
    try :
        ...
        time_node.get_logger().info("Keyboard interrupted!!")
    finally:
        msg_node.destroy_node()
        time_node.destroy_node()
        rclpy.shutdown()


if __name__ == "__main__":
    print('ROS2 Homework1018 Package hw_sub2')
    main()
